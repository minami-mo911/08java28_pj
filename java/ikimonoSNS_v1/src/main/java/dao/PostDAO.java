...
public class PostDAO {
    ...
    public List<Post> findAll(){
        ...
        try (Connection connection = DBUtil.getConnection()) {  // ここでConnectionを取得
    ...
    public boolean create(Post post, int categoryId) {
        try (Connection connection = DBUtil.getConnection()) {  // ここでConnectionを取得
            ...
            try (PreparedStatement pStmtPost = connection.prepareStatement(sqlPost, PreparedStatement.RETURN_GENERATED_KEYS)) {
                ...
                if (post.getImageUrl() != null && !post.getImageUrl().isEmpty()) {
                    ...
                    try (PreparedStatement pStmtPicture = connection.prepareStatement(sqlPicture)) {
                ...
                try (PreparedStatement pStmtCategory = connection.prepareStatement(sqlCategory)) {
